...
data object SdkKeyword {
    ...
    private val sdkLists = listOf(
        ...
        Sdk("OPPO", listOf("oppo", "heytap", "oneplus")),
        Sdk("vivo", listOf("vivo")),
        Sdk("XiaoMi", listOf("xiaomi", "miui", "hyper", "com.mi.")),
        Sdk("Microsoft", listOf("microsoft")),
        Sdk("Chrome", listOf("chrome", "chromium")),
