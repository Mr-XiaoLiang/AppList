...
object AdsSDK {
    ...
    val list = arrayOf<SDK.ADS>(
        ...
        ads(
            label = "AlgoriX",
            website = "https://www.algorix.co/",
            keywords = listOf("com.alxad")
        ) {},
        ads(
            label = "Amazon",
        ...
        ads(
            ...
            keywords = listOf("com.appnext.ads")
        ) {},
        ads(
            label = "Baidu",
            website = "https://union.baidu.com/bqt/#/",
            keywords = listOf("com.baidu.mobads")
        ) {},
        ads(
            label = "BeesAds",
            website = "https://www.beesads.com/",
            keywords = listOf("com.beesads")
        ) {},
        ads(
            label = "Beizi",
            website = "http://www.beizi.biz/#/home/index",
            keywords = listOf("com.beizi")
        ) {},
        ads(
            label = "BidMachine",
            website = "https://bidmachine.io/",
            keywords = listOf("io.bidmachine")
        ) {},
        ads(
            label = "Bigo",
            website = "https://www.bigoads.com/",
            keywords = listOf("sg.bigo.ads")
        ) {},
        ads(
            label = "Chartboost",
        ...
        ads(
            ...
            keywords = listOf("com.bytedance.sdk.openadsdk", "com.bytedance.sdk.pangle")
        ) {},
        ads(
            label = "Criteo",
            website = "https://www.criteo.com/",
            keywords = listOf("com.criteo")
        ) {},
        ads(
        ...
        ads(
            ...
            keywords = listOf("com.google.android.gms")
        ) {},
        ads(
        ...
        ads(
            label = "HyprMX",
            website = "https://www.hyprmx.com/",
            keywords = listOf("com.hyprmx.android")
        ) {},
        ads(
            label = "IMA(Google)",
        ...
        ads(
            label = "KuaiShou",
            website = "https://ad.e.kuaishou.com/welcome",
            keywords = listOf("com.kwad")
        ) {},
        ads(
            label = "Kwai",
            website = "https://ads.kwai.com/",
            keywords = listOf("com.kwai")
        ) {},
        ads(
        ...
        ads(
            ...
            keywords = listOf("com.facebook.ads")
        ) {},
        ...
        ads(
            label = "Moloco",
            website = "https://help.moloco.com/hc/zh-cn",
            keywords = listOf("com.moloco.sdk")
        ) {},
        ads(
            label = "OPPO",
            website = "https://u.oppomobile.com/#/",
            keywords = listOf("com.opos.mobad")
        ) {},
        ...
        ads(
            ...
            keywords = listOf("com.pubmatic.sdk")
        ) {},
        ...
        ads(
            ...
            keywords = listOf("com.smaato.sdk")
        ) {},
        ads(
            label = "Start.io",
        ...
        ads(
            label = "TapTap",
            website = "https://biz.taptap.cn/",
            keywords = listOf("com.tapsdk.tapad")
        ) {},
        ads(
            label = "Tapjoy",
        ...
        ads(
            label = "TaurusX",
            website = "https://taurusx.com/",
            keywords = listOf("com.taurusx.tax")
        ) {},
        ads(
            label = "Tencent",
            website = "https://ad.qq.com/",
            keywords = listOf("com.qq.e.ads", "com.qq.e.mediation")
        ) {},
        ads(
            label = "TradPlus",
            website = "https://www.tradplusad.com/",
            keywords = listOf("com.tradplus", "com.tradplus", "com.tp.adx", "tradplus.ad")
        ) {},
        ads(
            label = "TopOn",
        ...
        ads(
            ...
            keywords = listOf("com.unity3d.ads", "com.unity3d.services.ads")
        ) {},
        ads(
            label = "Verve(PubNative)",
            website = "https://verve.com/",
            keywords = listOf("net.pubnative.lite.sdk")
        ) {},
        ads(
            label = "VK(MyTarget)",
            website = "https://ads.vk.com/en",
            keywords = listOf("com.my.target")
        ) {},
//        ads(label = "XiaoMi", website = "http://ad.mi.com/", keywords = listOf()){},
        ...
        ads(
            ...
            keywords = listOf("com.zeus.gmc")
        ) {},
        ads(
            label = "YSONetwork",
            website = "https://www.ysonetwork.com/",
            keywords = listOf("com.ysocorp.ysonetwork")
        ) {},
        ads(
            label = "Yandex",
        ...
        ads(
            label = "vivo",
            website = "https://adnet.vivo.com.cn/home",
            keywords = listOf("com.vivo.mobilead")
        ) {},
        ads(
            label = "zMaticoo",
            website = "https://www.zmaticoo.com/",
            keywords = listOf("com.maticoo.sdk")
        ) {},
    )
    ...
    private fun ads(
        ...
        adKeyword: AdKeyword.Builder.() -> Unit
    ): SDK.ADS {
        return SDK.ADS(
            label = label,
            website = website,
            keywords = keywords,
            adKeyword = AdKeyword.create(adKeyword)
        )
    }
